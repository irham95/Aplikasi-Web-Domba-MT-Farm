        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation no-print">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <img src="./image/mt3.png" class="user-image img-responsive"/>
                    </li>


                    <li class="<?=is_same(2,$menu,"active")?>">
                        <a href="javascript:;" data-toggle="collapse" data-target="#master"><i class="fa fa-fw fa-file-text-o"></i> Data Domba <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="master"  class="<?=is_not_same(2,$menu,"collapse")?>">
                            <li class="<?=is_same(21,$submenu,"active")?>">
                                <a href="master/cc">Data Domba Masuk</a>
                            </li>
                    ...
                    <li class="<?=is_same(3,$menu,"active")?>">
                        <a href="mutasi/penerimaan"><i class="fa fa-fw fa-bars"></i> Rekap Stok Data Domba</a>
                    </li>
                    <li class="<?=is_same(4,$menu,"active")?>">
                        <a href="mutasi/pengiriman"><i class="fa fa-fw fa-picture-o"></i> Rekap Stok per Divisi</a>
                    </li>
                    <li class="<?=is_same(5,$menu,"active")?>">
                        <a href="laporan"><i class="fa fa-fw fa-bookmark"></i> Laporan</a>
                    </li>
                    <li class="<?=is_same(6,$menu,"active")?>">
                        <a href="history"><i class="fa fa-fw fa-cog"></i> Riwayat</a>
                    </li>
                    <li class="<?=is_same(7,$menu,"active")?>">
                        <a href="home/logout"><i class="fa fa-fw fa-power-off"></i> Logout</a>
                    </li>
